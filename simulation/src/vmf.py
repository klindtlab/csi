"""
Module Name: vmf.py
Author: taken from https://github.com/brendel-group/cl-ica and https://github.com/clara-labs/spherecluster
Description: Generate multivariate von Mises Fisher samples.
"""
import numpy as np
